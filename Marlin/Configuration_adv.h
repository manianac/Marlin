...
#define USE_CONTROLLER_FAN
  ...
  //#define CONTROLLER_FAN_MIN_BOh noOARD_TEMP 40  // (°C) Turn on the fan if the board reaches this temperature
...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  //#define USE_OCR2A_AS_TOP
    ...
    #else
      #define FAST_PWM_FAN_FREQUENCY 30000U
    #endif
  #endif
#endif
...
#define CASE_LIGHT_ENABLE
  ...
  //#define CASE_LIGHT_PIN PB5                  // Override the default pin if needed
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_XY { {  34, 135 }, { 240,  135 } }
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  40, 40 }, { 230,  20 }, { 230, 260 }, { 40, 230 } }
...
#define FWRETRACT
  ...
  #define RETRACT_FEEDRATE              6   // (mm/s) Default feedrate for retracting
...
#define FILAMENT_WIDTH_SENSOR
  ...
  #define FILWIDTH_ERROR_MARGIN        0.3  // (mm) If a measurement differs too much from nominal width ignore it
...
//#define NO_VOLUMETRICS
  ...
  //#define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT 20.00      // (mm^3/sec)
  #endif
#endif
